...
- SA-MP 0.3.7 client to connect — official download page: https://www.sa-mp.mp/downloads
- SA-MP server package (not included) — same official download page: https://www.sa-mp.mp/downloads
